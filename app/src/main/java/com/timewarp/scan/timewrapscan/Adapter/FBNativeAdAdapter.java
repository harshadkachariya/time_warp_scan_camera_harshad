...
public class FBNativeAdAdapter extends RecyclerViewAdapterWrapper {
    ...
    private void onBindAdViewHolder(final RecyclerView.ViewHolder holder) {
        ...
        if (mParam.forceReloadAdOnBind || !adHolder.loaded) {
            APIManager.showSmallNative(adHolder.nativeAdIcon);
        }
    }
    ...
    public static class Builder {
        ...
        public static Builder with(Activity activity, RecyclerView.Adapter wrapped) {
            ...
            param.itemContainerLayoutRes = R.layout.ads_layout;
            param.itemContainerId = R.id.adContainer;
    ...
    private static class AdViewHolder extends RecyclerView.ViewHolder {
        RelativeLayout nativeAdIcon;

        boolean loaded;

        AdViewHolder(View view) {
            super(view);
            nativeAdIcon = view.findViewById(R.id.adContainer);
            loaded = false;
        }

        Context getContext() {
            return nativeAdIcon.getContext();
        }
    }
}